<template>
  <div class="result">
    ...
    <drivers :theme="'dark'" :drivers="currSlide.suggestions" class="bixby-suggestion" :sayWord="currSlide.sayWord" :toggle="!isRemoteEnabled" ></drivers>
  </div>
</template>
<script>
...
export default {
  ...
  methods: {
    ...
    handleKeyDown(type) {
      ...
      switch (type) {
        case 'BACK':
          this.$emit('exit', { from: 'spotifyhome' });
          break;
        default:
          break;
      }
